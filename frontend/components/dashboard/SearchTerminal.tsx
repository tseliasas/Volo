...
export default function SearchTerminal({
  ...
  const delayedOptimize = (
    ...
    debounceRef.current = setTimeout(() => {
      onOptimize(budgetValue, paxValue, originValue, queryValue, start, end);
    }, 1000);
  };
  ...
  return (
    <div className="flex items-stretch rounded-[28px] overflow-hidden bg-[#0B1520] border border-cyan-400/40 shadow-[0_0_40px_rgba(0,255,255,0.20)]">
            ...
            <div className="flex items-center gap-1">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  delayedOptimize(internalValue, pax, origin, searchText, startDate, endDate);
                }}
                onKeyDown={(e) => {
                  if (e.key === "Enter") {
                    onOptimize(budget, pax, origin, searchText, startDate, endDate);
        ...
        <div className="flex gap-2">
          {[1, 2, 3, 4].map((num) => (
            <button
              ...
              onClick={() => {
                setPax(num);
                delayedOptimize(budget, num, origin, searchText, startDate, endDate);
              }}
              className={`px-3 py-1.5 rounded-full text-sm transition-all ${
      ...
      {/* ======================================
          TRAVEL DATES (NEW)
      ====================================== */}
      <div className="px-6 py-2 flex flex-col justify-center border-r border-white/5">
        ...
        <div className="flex gap-2 items-center">
          <input
            ...
            onChange={(e) => {
              ...
              delayedOptimize(budget, pax, origin, searchText, e.target.value, endDate);
            }}
          ...
          <input
            ...
            onChange={(e) => {
              ...
              delayedOptimize(budget, pax, origin, searchText, startDate, e.target.value);
            }}
            className="bg-transparent text-sm text-gray-300 outline-none cursor-pointer [color-scheme:dark]"
          />
        </div>
      ...
      <div className="px-8 flex items-center border-r border-white/5 hover:bg-white/5 transition-colors">
        <select
          ...
          onChange={(e) => {
            ...
            delayedOptimize(budget, pax, e.target.value, searchText, startDate, endDate);
          }}
