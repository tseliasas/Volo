...
export default function VoloIdleState() {
  return (
    <div className="w-full min-h-[420px] flex flex-col items-center justify-center rounded-[28px] border border-white/10 bg-[#0B1120] relative overflow-hidden mt-8 px-4">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full mt-4">
        ...
        <div className="relative flex items-center justify-center w-52 h-52 mb-8 shrink-0 sm:w-64 sm:h-64">
          ...
          <div className="absolute inset-0 border-[1.5px] border-emerald-500/30 rounded-full animate-[spin_15s_linear_infinite_reverse]">
            <div className="absolute top-1/2 -right-5 -translate-y-1/2 bg-[#050B14] p-2.5 rounded-full border border-emerald-400">
              <Wallet className="w-5 h-5 text-emerald-300" />
            </div>
            <div className="absolute bottom-2 left-8 bg-[#050B14] p-2 rounded-full border border-emerald-400">
              <MapPin className="w-4 h-4 text-emerald-300" />
            </div>
          </div>

          <div className="absolute w-36 h-36 border-[1.5px] border-emerald-400/50 rounded-full animate-[spin_8s_linear_infinite] border-dashed sm:w-44 sm:h-44">
            <div className="absolute -top-5 left-1/2 -translate-x-1/2 bg-[#050B14] p-2.5 rounded-full border border-emerald-400">
          ...
          <div className="w-20 h-20 bg-[#0B1520] border-2 border-emerald-400 rounded-full flex items-center justify-center z-10 relative overflow-hidden">
